...
FLAG = os.getenv('FLAG') or 'FLAG{SAMPLE}'
...
class Bob:
    ...
    def __init__(self, *args, **kwargs):
        """ Load the psk from kwargs[psk_file]. """
        psk_file = kwargs.get('psk_file', PSK_FILE)
        self.psk = self._load_psk(psk_file)

    def _load_psk(self, psk_file):
        """ Load the PSK from psk_file """
